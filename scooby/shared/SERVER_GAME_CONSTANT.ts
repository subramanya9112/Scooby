...
export const GAME_SERVER_ENEMY_TAKE_DAMAGE = 'game_server_enemyTakeDamage';
export const GAME_SERVER_PLAYER_TAKE_DAMAGE = 'game_server_playerTakeDamage';
...
export const SERVER_GAME_OPEN_DOOR = 'server_game_openDoor';
export const SERVER_GAME_ENEMY_REMOVE = 'server_game_enemyRemove';
export const SERVER_GAME_PLAYER_DIED = 'server_game_playerDied';
export const SERVER_GAME_PLAYER_HEALTH = 'server_game_playerHealth';
export const SERVER_GAME_PLAYER_XP = 'server_game_playerXP';
